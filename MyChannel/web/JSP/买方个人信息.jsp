...
<div id="personalInformationDiv">
    ...
    <div id="personalInformationLeftDiv">
        <div id="personalInformationHeadDiv" style="cursor: pointer">
            <div id="personalInformationHead">
                <img id="personalInformationHeadImg" src="${sessionScope.user.userHeadUrl164}"/>
            </div>
            ...
            <div id="personalInformation-ShouHuoAddress-Editor-div">
                <form action="#" method="get" class="form-horizontal">
                    <div class="personalInformationChangeForm-div" style="height: 64px;padding-top: 22px;">
                        ...
                        <select class="personalInformation-Address province" style="width: 98px;">
                            <option value="AL">浙江</option>
                            <option value="WY">陕西</option>
                        </select>
                        <select class="personalInformation-Address city" style="width: 98px;">
                            <option value="AL">绍兴</option>
                            <option value="WY">西安</option>
                        </select>
                        <select class="personalInformation-Address area" style="width: 98px;">
                            <option value="AL">上虞</option>
                            <option value="WY">长安区</option>
                        </select>
                    </div>
                    ...
                    <div class="personalInformationChangeForm-div">
                        ...
                        <div class="personalInformation-input-div">
                            <input type="text" class="span4" placeholder="Your IdentityId"/>
                        </div>
                    </div>
                    <div class="personalInformationChangeForm-div">
                    ...
                    <div class="personalInformationChangeForm-save">
                        ...
                        <button type="submit" class="btn" id="personalInformationChangeForm-cancle-save-button">返回
                        </button>
                    </div>
            ...
            <div id="personalInformation-PasswordChange-Editor-div">
                <form action="#" method="get" class="form-horizontal">
                    <div class="personalInformationChangeForm-div">
                        ...
                        <div class="personalInformation-input-div">
                            <input type="password" class="span4" placeholder="Your IdentityId"/>
                        </div>
                    </div>
                    <div class="personalInformationChangeForm-div">
                        <label class="personalInformation-label">* 新密码 :</label>
                        <div class="personalInformation-input-div">
                            <input type="password" class="span4" placeholder="Your phone number"/>
                        </div>
                    </div>
                    <div class="personalInformationChangeForm-div">
                        <label class="personalInformation-label">* 确认密码 :</label>
                        <div class="personalInformation-input-div">
                            <input type="password" class="span4" placeholder="Your phone number"/>
                        </div>
                    </div>
      ...
      height: 350px;" id="personalInformationRightDivUl">
                ...
                <li class="personalInformationHeadChange" id="headEditorDiv">
                    <div id="headEditorDiv-first">
                        ...
                        <img id="personalInformationHeadImg60" src="${sessionScope.user.userHeadUrl60}"/>
                ...
                <div class="personalInformationChangeDiv">
                    <div class="personalInformationChangeDivContent nopadding">
                        <form id="personalInformationForm" action="userActionNoModelDriven_personalInformationSave.action" method="post" class="form-horizontal">
                            <div class="personalInformationChangeForm-div">
                            ...
                            <div class="personalInformationChangeForm-div" style="height: 64px;">
                                ...
                                <select class="personalInformation-Address province" style="width: 98px;" name="UserProvince">
                                ...
                                <select class="personalInformation-Address city" style="width: 98px;" name="UserCity">
                                ...
                                <select class="personalInformation-Address area" style="width: 98px;" name="UserArea">
                                    ...
                                    <option value="上虞">上虞</option>
                                    <option value="长安区">长安区</option>
                                </select>
                            </div>
                            <div class="personalInformationChangeForm-div" style="height: 64px;">
                                <label class="personalInformation-label">* 生日 :</label>
                                <select class="personalInformation-birth year" style="width: 98px;" name="UserBirthYear">
                                ...
                                <select class="personalInformation-birth month" style="width: 98px;" name="UserBirthMonth">
                            ...
                            <div class="personalInformationChangeForm-div">
                                ...
                                <div class="personalInformation-input-div">
                                    <input type="text" class="span4" placeholder="Your IdentityId" name="UserIdentity" value="${sessionScope.user.userIdentity}"/>
                                </div>
                            </div>
                            <div class="personalInformationChangeForm-save">
                                <button type="submit" class="btn btn-success">Save</button>
    ...
    <div id="headEditorDiv-third" style="display: none">
        ...
        <div id="headEditorDiv-third-top">
            <input type="file" class="sr-only" id="inputImage" name="file" accept=".jpg,.jpeg,.png,.gif,.bmp,.tiff" style="float: right;position: relative;right: 83%;width: 17%;padding-top: 2%;opacity: 0;z-index: 10;"/>
