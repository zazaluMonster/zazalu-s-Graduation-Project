...
<body>
  ...
  <ul>
    ...
    <li class="active"><a href="${pageContext.request.contextPath}/JSP/GoodManage_ChangeGoodMessage_Browser.jsp"><i class="icon icon-wrench"></i> <span>商品信息修改</span></a></li>
              ...
              <div class="span6" style="width: 23%;">
                <table class="">
                  <tbody>
                    <tr>
                      <td>
                        <h4>${sessionScope.good.goodName}</h4>
                      </td>
                    </tr>
                    <tr>
                      <td>${sessionScope.good.goodDescrible}</td>
                    </tr>
                  </tbody>
                </table>
              </div>
                ...
                <table class="table table-bordered table-invoice">
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="width70"><strong>${sessionScope.good.goodId}</strong></td>
                    </tr>
                    <tr>
                      <td class="width30">商品价格 :</td>
                      <td class="width70"><strong>${sessionScope.good.goodPrice}</strong></td>
                    </tr>
                    <tr>
                      <td>净含量 :</td>
                      <td><strong>${sessionScope.good.goodNetWeight}</strong></td>
                    </tr>
                    <tr>
                      <td>颜色 :</td>
                      <td><strong>${sessionScope.good.goodColor}</strong></td>
                    </tr>
                    <tr>
                      <td>商品补充说明 :</td>
                      <td><strong>${sessionScope.good.goodMessage}</strong></td>
                    </tr>
                    <tr>
                      <td>折扣率 :</td>
                      <td><strong style="color: red">${sessionScope.good.goodDiscount}</strong></td>
                    </tr>
                    <tr>
                      <td>积分点 :</td>
                      <td><strong >${sessionScope.good.goodPoint}</strong></td>
                    </tr>
                  </tbody>
