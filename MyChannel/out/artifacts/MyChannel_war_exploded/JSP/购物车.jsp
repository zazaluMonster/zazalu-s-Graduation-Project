  ...
  <div id="personalInformationDiv">
    ...
    <div id="personalInformationRightDiv">
      <div id="personalInformationTrans">
        <div class="personalInformationRightUp"><a id="getDaiFaHuo" class="personalInformationRightUpA"><i class="icon icon-shopping-cart" style="margin-right: 8px;"></i>我的购物车</a>
