...
<body>
            ...
            <div class="widget-title"> <span class="icon"> <i class="icon-plus"></i> </span>
              <ul style="list-style: none;padding-top: 4px;">
                <li style="width: 100px;float: left;">
                  <select id="searchGood" class="searchType" style="width: 98px;" tabindex="-1" aria-hidden="true">
                    <option value="WY">商品名</option>
                  </select>
                </li>
  ...
  <script src="js/searchGood.js"></script>
  <%--下拉框--%>
