            ...
            <div class="widget-content">
              <div class="widget-content nopadding">
                <table class="table table-striped table-bordered">
                  ...
                  <tbody>
                    <tr>
                      <td class="taskDesc"><i class="icon-info-sign"></i> 订单号 : 1 / 买方名 : zazalu / 订单时间 : 2017.4.5 14:36:00</td>
                      <td class="taskStatus"><span class="in-progress">支付中</span></td>
                      <td class="taskOptions"><a href="#" class="tip-top" data-original-title="Update"><i class="icon-ok"></i></a> <a href="#" class="tip-top"
                          data-original-title="Delete"><i class="icon-remove"></i></a></td>
                    </tr>
                    <tr>
                      <td class="taskDesc"><i class="icon-plus-sign"></i> 订单号 : 1 / 买方名 : zazalu / 订单时间 : 2017.4.5 14:36:00</td>
                      <td class="taskStatus"><span class="pending">未支付</span></td>
                      <td class="taskOptions"><a href="#" class="tip-top" data-original-title="Update"><i class="icon-ok"></i></a> <a href="#" class="tip-top"
                          data-original-title="Delete"><i class="icon-remove"></i></a></td>
                    </tr>
                    <tr>
                      <td class="taskDesc"><i class="icon-ok-sign"></i> 订单号 : 1 / 买方名 : zazalu / 订单时间 : 2017.4.5 14:36:00</td>
                      <td class="taskStatus"><span class="done">交易完成</span></td>
                      <td class="taskOptions"><a href="#" class="tip-top" data-original-title="Update"><i class="icon-ok"></i></a> <a href="#" class="tip-top"
                          data-original-title="Delete"><i class="icon-remove"></i></a></td>
                    </tr>
                  </tbody>
