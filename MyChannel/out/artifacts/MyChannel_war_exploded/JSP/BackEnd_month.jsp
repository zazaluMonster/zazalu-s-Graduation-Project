...
<head>
  ...
  <link rel="stylesheet" href="css/monthTrans.css">
...
<body>
  ...
  <div id="sidebar">
    ...
    <ul>
      ...
      <li class="active"><a href="BackEnd_month.jsp"><i class="icon icon-tag"></i> <span>月交易统计</span></a> </li>
              ...
              <div class="widget-content nopadding">
                <ul class="recent-posts">
                  <div class="form-actions">
                    <select id="yearSelect" style="width: 98px;">
  ...
  <script src="js/monthTrans.js"></script>
